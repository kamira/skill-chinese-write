...
> 本欄原寫「施工中 — 待 ACC-20260814-07」,而該 ACC 早已結案、該張早已 merge。
> `doc_integrity_check` 只檢查本節**存不存在**,不檢查它說什麼——
> 「施工中」不是可辨識的佔位字串,是一句看起來完整的假陳述。
> 由 `CHG-20260817-03` 具名更正;缺的那道閘記為 `BL-024`。
