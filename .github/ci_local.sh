...
echo "[1/7] 實際操作驗收(含漂移紅燈可達探針)"
bash .github/verify.sh

echo "[2/7] writing 風格 lint 夾具:好樣本要過、壞樣本要擋"
...
echo "[3/7] fiction lint 夾具:好樣本要過、壞樣本要擋"
...
echo "[4/7] techdoc lint 夾具:兩份 good 要過、bad 在兩種 kind 都要被擋"
...
echo "[7/7] catalog 版本(靜態 + 變動就要 bump)"
